...
const Quote = () => {
  return (
    <>
      <Helmet>
        <title>Get a Quote - jkoneply</title>
        <meta name="description" content="Request a custom quote for your plywood and timber project from jkoneply. Provide your specifications and we'll give you a detailed estimate." />
      </Helmet>
      ...
      >
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-[rgb(var(--color-primary-600))] to-[rgb(var(--color-accent-600))] dark:from-[rgb(var(--color-primary-800))] dark:to-[rgb(var(--color-accent-800))] py-16 md:py-24 overflow-hidden">
        ...
        {/* Quote Form Section */}
        <section className="py-12 bg-[rgb(var(--color-secondary-50))] dark:bg-[rgb(var(--color-secondary-900))]/50">
          ...
          <div className="container mx-auto px-4">
            <motion.div variants={fadeIn} className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[rgb(var(--color-secondary-900))] dark:text-white mb-4">
                Why Choose jkoneply for Your Project?
              </h2>
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white dark:bg-[rgb(var(--color-secondary-800))] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-[rgb(var(--color-secondary-200))] dark:border-[rgb(var(--color-secondary-700))] group"
                >
                  <div className="w-16 h-16 bg-[rgb(var(--color-primary-100))] dark:bg-[rgb(var(--color-primary-900))]/50 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-[rgb(var(--color-primary-600))] group-hover:text-white transition-colors duration-300">
                    {item.icon}
                  </div>
